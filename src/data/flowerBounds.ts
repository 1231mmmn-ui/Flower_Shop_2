...
export const FLOWER_BOUNDS: Record<string, FlowerBounds> = {
  ...
  eucalyptus: { top: 0.0156, bottom: 0.998, left: 0.3047, right: 0.6943, presence: 1.05 },
  ...
  muscari: { top: 0.0693, bottom: 0.9961, left: 0.3164, right: 0.6885, presence: 1.07 },
  ...
  rose: { top: 0.0273, bottom: 0.998, left: 0.2285, right: 0.7686, presence: 0.94 },
