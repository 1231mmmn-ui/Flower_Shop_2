...
export const FLOWER_BOUNDS: Record<string, FlowerBounds> = {
  ...
  eucalyptus: { top: 0.0469, bottom: 0.9834, left: 0.2812, right: 0.7188, presence: 1.01 },
  ...
  muscari: { top: 0.0449, bottom: 0.9844, left: 0.3545, right: 0.6445, presence: 1.17 },
  ...
  rose: { top: 0.0459, bottom: 0.9844, left: 0.2402, right: 0.7588, presence: 0.95 },
